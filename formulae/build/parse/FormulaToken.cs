...
namespace formulae.build.parse
{
    ...
    public enum FormulaToken
    {
        ...
        [Lexeme(GenericToken.SugarToken, "+")] PLUS = 4,

        [Lexeme(GenericToken.SugarToken, "-")] MINUS = 5,
        ...
        [Lexeme(GenericToken.KeyWord, "TRUE")] [Lexeme(GenericToken.KeyWord, "VRAI")]
        TRUE = 150,

        [Lexeme(GenericToken.KeyWord, "FALSE")] [Lexeme(GenericToken.KeyWord, "FAUX")]
        FALSE = 151
    }
}